...
if ($resultat->num_rows > 0){
	while($zeile=$resultat->fetch_assoc()){
		echo "<form action='loeschen_durchfuehren.php' method='POST'>";
		...
		echo "Firma:<br/>";
		echo "<input type='text' readonly name='Firma' value = '".$zeile["Firma"]."' /><br/>";
		
		echo "Strasse:<br/>";
		echo "<input type='text' readonly name='Strasse' value = '".$zeile["Strasse"]."' /><br/>";
		
		echo "Ort:<br/>";
		echo "<input type='text' readonly name='Ort' value = '".$zeile["Ort"]."' /><br/>";
		
		echo "Bundesland:<br/>";
		echo "<input type='text' readonly name='Bundesland' value = '".$zeile["Bundesland"]."' /><br/>";
		
		echo "Postleitzahl:<br/>";
		echo "<input type='text' readonly name='Postleitzahl' value = '".$zeile["Postleitzahl"]."' /><br/>";
		
		echo "Land:<br/>";
		echo "<input type='text' readonly name='Land' value = '".$zeile["Land"]."' /><br/>";
